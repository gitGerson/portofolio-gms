...
- **Data layer** (`lib/data/*`): server-only query modules mapping snake_case rows → camelCase domain types (`lib/data/types.ts`). Don't query Supabase directly from pages — go through these.
